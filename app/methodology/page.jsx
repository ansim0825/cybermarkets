...
export default function Page() {
  ...
  const phases = [
    ...
    },
    {
      ...
      questions: [
        ...
        'PM imperatives: What is table stakes vs. differentiator?',
  ...
  const strategicBrief = [
    ...
    { section: 'Competitive Landscape', pages: '4 pages', items: ['Positioning matrix (with visual)', 'Top 5 competitors analyzed', 'Company current position and opportunity'] },
          ...
          <div className="bg-gradient-to-br from-blue-900/30 to-purple-900/30 rounded-xl border border-blue-800 p-8">
            ...
            <div className="grid md:grid-cols-3 gap-6 text-center">
              ...
              <div>
                ...
                <p className="text-sm text-gray-400">Every analysis ends with If I am a PM here, I need to know</p>
              </div>
            </div>
          </div>
        </div>
